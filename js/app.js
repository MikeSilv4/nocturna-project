 ...
 */
    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    const radioGroupName = formRequiredItem.name;
                    const radioInputs = document.querySelectorAll(`input[type="radio"][name="${radioGroupName}"]`);
                    let radioChecked = false;
                    for (let i = 0; i < radioInputs.length; i++) if (radioInputs[i].checked) {
                        radioChecked = true;
                        break;
                    }
                    const radioGroupContainer = formRequiredItem.closest(".form-checkout__item--radio");
                    if (!radioChecked) {
                        this.addError(radioGroupContainer || formRequiredItem);
                        error++;
                    } else this.removeError(radioGroupContainer || formRequiredItem);
                }
                return error;
            },
        ...
        window.initSliders = function() {
            var slider = document.querySelector(".category__slider");
            ...
            if (productSliders) productSliders.forEach((function(productSlider) {
                var prevButton = productSlider.querySelector(".product__swiper-button-prev");
                var nextButton = productSlider.querySelector(".product__swiper-button-next");
...
***************************************************************************** */
        ...
        function executeGotoBlock() {
            gotoblock_gotoBlock(".tabs__bar", true, 200);
        }
        const filtersList = document.querySelectorAll(".tabs-product__info");
